...
if __name__ == "__main__":
    print(
        f"Starting XLNet model training with {CROSS_VAL_FOLDS}-fold cross-validation")
    print(
    ...
    test_report = evaluate_model(
        model, tokenizer, test_dataset, class_names, device)
    ...
    print(
        "XLNet weighted F1-score: {:.4f}".format(test_report['weighted avg']['f1-score']))
...
Authentic: F1=0.8636, Precision=0.9048, Recall=0.8261
Generic: F1=0.8333, Precision=0.7895, Recall=0.8824

Overall: F1=0.8806, Accuracy=0.8800
    """
